...
@class PrestaShop_iOS_WebViewRenderer;
@class UNUserNotificationCenterDelegate;
@class PrestaShop_iOS_NotificationServices_iOSNotificationReceiver;
@class UIApplicationDelegate;
@class Xamarin_Forms_Platform_iOS_FormsApplicationDelegate;
@class AppDelegate;
@class WKNavigationDelegate;
@class PrestaShop_iOS_CustomNavigationDelegate;
...
@interface PrestaShop_iOS_WebViewRenderer : Xamarin_Forms_Platform_iOS_WkWebViewRenderer {
}
	-(id) init;
@end
...
@interface PrestaShop_iOS_NotificationServices_iOSNotificationReceiver : NSObject<UNUserNotificationCenterDelegate> {
}
	-(void) release;
	-(id) retain;
	-(uint32_t) xamarinGetGCHandle;
...
@interface PrestaShop_iOS_CustomNavigationDelegate : NSObject<WKNavigationDelegate> {
}
	-(void) release;
	-(id) retain;
	-(uint32_t) xamarinGetGCHandle;
