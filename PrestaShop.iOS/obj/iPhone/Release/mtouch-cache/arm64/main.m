...
extern void *mono_aot_module_PrestaShop_iOS_info;
...
extern void *mono_aot_module_PrestaShop_info;
extern void *mono_aot_module_Xamarin_Forms_Xaml_info;
extern void *mono_aot_module_RestSharp_info;
extern void *mono_aot_module_Matcha_BackgroundService_info;
...
extern void *mono_aot_module_Matcha_BackgroundService_iOS_info;

void xamarin_register_modules_impl ()
{
	mono_aot_register_module (mono_aot_module_PrestaShop_iOS_info);
	...
	mono_aot_register_module (mono_aot_module_PrestaShop_info);
	mono_aot_register_module (mono_aot_module_Xamarin_Forms_Xaml_info);
	mono_aot_register_module (mono_aot_module_RestSharp_info);
	mono_aot_register_module (mono_aot_module_Matcha_BackgroundService_info);
	...
	mono_aot_register_module (mono_aot_module_Matcha_BackgroundService_iOS_info);
...
void xamarin_setup_impl ()
{
	...
	xamarin_executable_name = "PrestaShop.iOS.exe";
	mono_use_llvm = FALSE;
	xamarin_log_level = 0;
